...
do
	...
	function component.add(vdev)
		...
		Kocos.push("component_added", vdev.address, vdev.type)
		return vdev.address
	end
	...
	function component.remove(address)
		...
		Kocos.push("component_removed", v.address, v.type)
	end
